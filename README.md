...
```txt
APP_SECRET=
LEMON_SQUEEZY_INDIVIDUAL_URL=
LEMON_SQUEEZY_PACK5_URL=
...
LEMON_SQUEEZY_PACK5_PRODUCT_ID=
...
- Product ID: aparece en la URL del producto. Para el Pack de 20 actual es `1156508`.
